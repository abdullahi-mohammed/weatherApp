            ...
            {weatherTodayData &&
                <>
                    <div>
                        <div>
                            <p>Feels like</p>
                            <p className={styles.degree}>{weatherTodayData.day.avgtemp_c}°</p></div>
                        <div>
                    ...
                    <ul>
                        <li>
                            ...
                            <p>{weatherTodayData.day.maxtemp_c}°/{weatherTodayData.day.mintemp_c}°</p>
                        </li>
                        <li>
                            <div>
                            ...
                            <p>{weatherTodayData.hour[0].wind_kph} km/h</p>
                        </li>
                        <li>
                            <div>
                            ...
                            <p>{weatherTodayData.day.avghumidity}%</p>
                        </li>
                        <li>
                            <div>
                        ...
                        <li>
                            ...
                            <p>{weatherTodayData.hour[0].pressure_mb} mb</p>
                        </li>
                        <li>
                            <div>
                            ...
                            <p>{weatherTodayData.day.uv} of 11</p>
                        </li>
                        <li>
                            <div>
                            ...
                            <p>{weatherTodayData.hour[0].vis_km} km</p>
                        </li>
                        <li>
                            <div>
                            ...
                            <p>{weatherTodayData.astro.moon_phase}</p>
                        </li>
